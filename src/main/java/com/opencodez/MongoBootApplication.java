...
public class MongoBootApplication {
	  ...
	  @Autowired CustomRepository crepo;
	...
	/*
	 * @Override public void run(String... args) throws Exception { deleteAll();
	 * addSampleData(); listAll(); findFirst(); findByRegex(); }
	 * 
	 * public void deleteAll() { System.out.println("Deleting all records..");
	 * repository.deleteAll(); }
	 * 
	 * public void addSampleData() { System.out.println("Adding sample data");
	 ...
	 * 
	 * public void listAll() { System.out.println("Listing sample data");
	 * repository.findAll().forEach(u -> System.out.println(u)); }
	 * 
	 * public void findFirst() { System.out.println("Finding first by Name"); Users
	 * u = repository.findFirstByName("Louise Litt"); System.out.println(u); }
	 * 
	 * public void findByRegex() {
	 * System.out.println("Finding by Regex - All with address starting with ^New");
	 * repository.findCustomByRegExAddress("^New").forEach(u ->
